...
class _SellerOrdersScreenState extends State<SellerOrdersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //LayoutBuilder to constrain the Column height
    return LayoutBuilder(
      builder: (context, constraints) {
        return Container(
          ...
          child: Column(
            children: [
              // Top section: chips, search bar, filter chips
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    // Search bar – wrapped in Card to provide Material ancestor
                    Card(
                    ...
                    Align(
                      ...
                      child: Text('${filtered.length} Orders',
                          style: GoogleFonts.poppins(
                            fontSize: 13,
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(20)),
                  child: Text(order.status ?? '', style: GoogleFonts.poppins(
